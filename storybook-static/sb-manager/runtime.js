...
`, Container7 = styled.div({
  minWidth: 250
}), SidebarButton = styled(Button)(buttonStyleAdditions), SidebarToggleButton = styled(ToggleButton)(buttonStyleAdditions), Menuactions = styled.div({
  display: "flex",
  gap: 6
  ...
  return isMobile2 ? react_default.createElement(Menuactions, null, react_default.createElement(
    SidebarButton,
    {
      padding: "small",
      variant: "ghost",
